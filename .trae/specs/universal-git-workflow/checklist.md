...
## 隐私过滤
- [x] 敏感文件清单：文档包含 `.trae/`、`bak/`、数据库、凭据等禁止提交的完整清单
- [x] 敏感内容检测：文档包含 Token/密码/手机号等提交消息脱敏规则
- [x] .gitignore 管理：文档包含自动检测缺失 .gitignore 并建议创建的逻辑
- [x] 泄露补救：文档包含已推送敏感信息的 filter-branch 清理流程和 Token 轮换提醒
- [x] SKILL.md 脱敏：文档中不包含任何硬编码的真实凭据
